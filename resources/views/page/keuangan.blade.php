...
@section('content')
    ...
    <div class="w-full h-full flex justify-center items-center mb-8">
    ...
    <section class="w-full h-full lg:flex justify-center items-center">

        <div class="lg:w-[50%] mb-5 lg:mb-0 flex justify-center items-center">
            <div
    ...
    {{-- Total tabungan --}}
    <div class="flex justify-center items-center mt-7 lg:mt-0">

        <div
            class="block max-w-xl z-10 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <div class="flex justify-center items-center">
                <h1 class="mr-2 font-semibold">Total Tabungan</h1>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    class="bi bi-wallet-fill mt-1" viewBox="0 0 16 16">
                    <path
            ...
            <p class="font-semibold text-center lg:mb-0 mb-5 mt-1 text-xl">Rp{{ $total_akhir_tabungan }}</p>
        </div>

    </div>

    {{-- Section 2 --}}
    <section class="w-full min-h-[100vh] mt-7 flex justify-center">
        <div class="bg-white shadow-lg rounded-lg w-[90%] min-h-[100vh] flex">

            <div class="w-full h-full flex">
                <div class="w-[50%] flex flex-col p-5">
                    <!-- Konten bagian pertama -->
                    <!-- Modal toggle -->
                    <button data-modal-target="crud-modal" data-modal-toggle="crud-modal"
                        class="block mb-6 text-white bg-emerald-400 hover:bg-emerald-500 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                        type="button">
                        Tambah Pemasukan +
                    </button>
                ...
                <div class="w-[50%] flex flex-col p-5">
                    ...
                    <button data-modal-target="pengeluaran" data-modal-toggle="pengeluaran"
                        class="block mb-6 text-white bg-pink-500 hover:bg-pink-600 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                        type="button">
                        Tambah Pengeluaran +
                    </button>
                    ...
                    <div id="pengeluaran" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <!-- Modal body -->
                                <form action="{{ route('pengeluaran.store') }}" method="POST" class="p-4 md:p-5">
                                    @csrf
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        <div class="col-span-2">
                                            <label for="date"
