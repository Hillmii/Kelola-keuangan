    ...
    <div class="w-full h-[80vh] flex justify-center items-center">
        <form method="POST" class="w-96 shadow-xl mx-3">
            ...
            <div class="w-full p-6 bg-white rounded-lg">
                <div class="mb-5">
                    <h1 class="mb-3 font-semibold text-lg text-center">Login</h1>
                ...
                <button type="submit"
                    class="text-white bg-emerald-400 hover:bg-emerald-500 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center">Login</button>
            </div>
        </form>
    </div>
@endsection
